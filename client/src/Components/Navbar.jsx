...
const NAV_ITEMS =[{title: "Home",link:''}, {title:"Event",link:'viewallprojectrequirment'},{title: "Learderboard", link:'viewallhackthonrequirment'}];
      ...
      <nav className="nb-root">
        <div className={`nb-inner${scrolled ? " nb-scrolled" : ""}`}>
          ...
          <Link to="/" className="nb-logo">
            ...
            <div className="nb-logo-text"> <span>CSS</span><span style={{ color: "#e1a203" }}>Event</span></div>
          </Link>

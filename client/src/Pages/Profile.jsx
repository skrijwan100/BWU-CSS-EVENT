...
import { Mail, GraduationCap, Github, Linkedin, Calendar, Code2, ArrowLeft, User, Globe, Phone } from 'lucide-react';
                  ...
                  <div className="profile-header-info">
                    ...
                    <div className="profile-meta">
                      ...
                      {profileData.studentCode && (
                        <div className="meta-item">
                          <GraduationCap size={16} />
                          <span>{profileData.studentCode}</span>
                        </div>
                      )}
                      {profileData.section && (
                        <div className="meta-item">
                          <GraduationCap size={16} />Section
